    ...
    <section class="section-news" style="margin-bottom:50px;">
        ...
        <div class="news-list" style="display:flex; gap:20px;">
            <div class="news-item" style="flex:1;">
                ...
                <h3>Cách phối đồ mùa hè năng động</h3>
                <p style="color:#666;">Mùa hè này mặc gì cho mát mẻ mà vẫn xinh?</p>
            </div>
            <div class="news-item" style="flex:1;">
                ...
                <h3>Xu hướng thời trang Gen Z năm 2025</h3>
                <p style="color:#666;">Những items không thể thiếu năm nay...</p>
            </div>
            <div class="news-item" style="flex:1;">
                ...
                <h3>Đàn ông mặc gì lịch lãm?</h3>
                <p style="color:#666;">5 set đồ phong cách – chuẩn men</p>
            </div>
        </div>
    </section>
