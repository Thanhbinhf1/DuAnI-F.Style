...
<body>
 ...
 <div class="admin-sidebar">
        <ul>
            ...
            <li><a href="<?= BASE_URL ?>?ctrl=admin&act=productList" class="<?= $current_act == 'productList' || $current_act == 'productForm' ? 'active' : '' ?>">📦 Sản phẩm</a></li> 
            
            <li><a href="<?= BASE_URL ?>?ctrl=admin&act=orderList" class="<?= $current_act == 'orderList' || $current_act == 'orderDetail' ? 'active' : '' ?>">📋 Đơn hàng</a></li> 
